        ...
        switch (item.getItemId()){
            case R.id.save_edit:
                ...
                if (title.equals("") && detail.equals("")){
                    Toast.makeText(EditActivity.this, "Tidak Tersimpan", Toast.LENGTH_SHORT).show();
                }else {
                    helper.updateData(values, id);
                    Toast.makeText(EditActivity.this, "Disimpan", Toast.LENGTH_SHORT).show();
                    finish();
                }
        }
        switch (item.getItemId()){
            case R.id.delete_edit:
                ...
                builder.setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(EditActivity.this, "Di Hapus", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
